		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Gestión Rondas",
									"targetURL": "#comodlrondas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comodlrondas-display": {
								"semanticObject": "comodlrondas",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.odl.rondas",
									"url": sap.ui.require.toUrl("com/odl/rondas")
								}
							}
						}
					}
